#
#  Be sure to run `pod spec lint PolygonSwift.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author       = "Antoni Remeseiro Alfonso"
  spec.homepage     = 'https://github.com/toniremi/PolygonioSwift'
